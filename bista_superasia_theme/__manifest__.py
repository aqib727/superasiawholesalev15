
{
    ...
    'license': 'AGPL-3',
    "depends": ['base','web','website','portal', 'product', 'sale', 'purchase', 'payment','website_sale','auth_signup','website_sale_delivery','website_sale_stock','sale_stock','website_crm'],
    "data": [
