        ...
        for inv in invoice_ids:
            ...
            if self.type == 'sal_report':
                for line in inv.invoice_line_ids:
                    ...
                    invname = inv.partner_id.name
                    custcode = ''
                    if invname:
                        invsp = invname.split()
                        invspfrst = invname.split()[0]
                        custcode = invsp and invspfrst
